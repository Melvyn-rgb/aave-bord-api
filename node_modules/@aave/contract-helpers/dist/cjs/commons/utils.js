...
const convertPopulatedTx = (tx) => {
    return Object.assign(Object.assign({}, tx), { value: tx.value ? ethers_1.BigNumber.from(tx.value) : ethers_1.BigNumber.from('0') });
};
exports.convertPopulatedTx = convertPopulatedTx;
