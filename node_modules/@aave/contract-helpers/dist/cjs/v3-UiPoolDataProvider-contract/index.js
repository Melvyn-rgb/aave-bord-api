...
const IUiPoolDataProviderV3__factory_1 = require("./typechain/IUiPoolDataProviderV3__factory");
...
class UiPoolDataProvider {
    ...
    constructor(context) {
        ...
        this._contract = IUiPoolDataProviderV3__factory_1.UiPoolDataProviderV3__factory.connect(context.uiPoolDataProviderAddress, context.provider);
    ...
    async getEModes({ lendingPoolAddressProvider, }) {
        if (!(0, utils_1.isAddress)(lendingPoolAddressProvider)) {
            throw new Error('Lending pool address is not valid');
        }
        return this._contract.getEModes(lendingPoolAddressProvider);
    }
    async getEModesHumanized({ lendingPoolAddressProvider, }) {
        if (!(0, utils_1.isAddress)(lendingPoolAddressProvider)) {
            throw new Error('Lending pool address is not valid');
        }
