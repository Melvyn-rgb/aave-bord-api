import { ReserveCalculationData, ReservesIncentiveDataHumanized } from './types';
...
export declare function calculateAllReserveIncentives({ reserveIncentives, reserves, marketReferenceCurrencyDecimals, }: CalculateAllReserveIncentivesRequest): ReserveIncentiveDict;
export {};
