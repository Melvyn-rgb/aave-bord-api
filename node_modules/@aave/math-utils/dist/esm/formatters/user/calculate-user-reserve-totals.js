    ...
    userReserves.forEach(userReserveSummary => {
        ...
        if (userReserveSummary.userReserve.reserve.reserveLiquidationThreshold !==
            ...
            if (userEmodeCategoryId &&
                ...
                currentLtv = currentLtv.plus(valueToBigNumber(userReserveSummary.underlyingBalanceMarketReferenceCurrency).multipliedBy(selectedEModeCategory.eMode.ltv));
                currentLiquidationThreshold = currentLiquidationThreshold.plus(valueToBigNumber(userReserveSummary.underlyingBalanceMarketReferenceCurrency).multipliedBy(selectedEModeCategory.eMode.liquidationThreshold));
            }
            else {
