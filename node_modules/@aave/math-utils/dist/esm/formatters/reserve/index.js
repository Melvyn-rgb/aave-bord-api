...
import { getAndFormatReserveEModes, } from '../emode';
 ...
 */
export function formatReserve({ reserve, currentTimestamp, eModes, }) {
 ...
 */
export function formatReserveUSD({ reserve, currentTimestamp, marketReferencePriceInUsd, marketReferenceCurrencyDecimals, eModes, }) {
...
export function formatReserves({ reserves, eModes, currentTimestamp, marketReferencePriceInUsd, marketReferenceCurrencyDecimals, }) {
...
export function formatReservesAndIncentives({ reserves, eModes, currentTimestamp, marketReferencePriceInUsd, marketReferenceCurrencyDecimals, reserveIncentives, }) {
