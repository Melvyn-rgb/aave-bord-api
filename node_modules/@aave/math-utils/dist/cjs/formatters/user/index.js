...
const calculate_all_user_incentives_1 = require("../incentive/calculate-all-user-incentives");
...
function formatUserSummaryAndIncentives({ currentTimestamp, marketReferencePriceInUsd, marketReferenceCurrencyDecimals, userReserves, formattedReserves, userEmodeCategoryId, reserveIncentives, userIncentives, }) {
    ...
    const calculatedUserIncentives = (0, calculate_all_user_incentives_1.calculateAllUserIncentives)({
        reserveIncentives,
        userIncentives,
