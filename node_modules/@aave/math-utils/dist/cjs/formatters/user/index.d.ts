...
import { UserIncentiveDict } from '../incentive/calculate-all-user-incentives';
import { ReservesIncentiveDataHumanized, UserReservesIncentivesDataHumanized } from '../incentive/types';
...
export interface CombinedReserveData<T extends FormatReserveUSDResponse = FormatReserveUSDResponse> extends UserReserveData {
    reserve: T;
}
export interface ComputedUserReserve<T extends FormatReserveUSDResponse = FormatReserveUSDResponse> extends CombinedReserveData<T> {
...
export interface FormatUserSummaryAndIncentivesRequest<T extends FormatReserveUSDResponse = FormatReserveUSDResponse> extends FormatUserSummaryRequest<T> {
    reserveIncentives: ReservesIncentiveDataHumanized[];
    userIncentives: UserReservesIncentivesDataHumanized[];
}
export interface FormatUserSummaryAndIncentivesResponse<T extends FormatReserveUSDResponse = FormatReserveUSDResponse> extends FormatUserSummaryResponse<T> {
    calculatedUserIncentives: UserIncentiveDict;
}
export declare function formatUserSummary<T extends FormatReserveUSDResponse = FormatReserveUSDResponse>({ currentTimestamp, marketReferencePriceInUsd, marketReferenceCurrencyDecimals, userReserves, formattedReserves, userEmodeCategoryId, }: FormatUserSummaryRequest<T>): FormatUserSummaryResponse<T>;
