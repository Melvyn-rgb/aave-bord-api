...
function calculateIncentiveAPR({ emissionPerSecond, rewardTokenPriceInMarketReferenceCurrency, priceInMarketReferenceCurrency, totalTokenSupply, rewardTokenDecimals, decimals, }) {
    const emissionPerSecondNormalized = (0, bignumber_1.normalizeBN)(emissionPerSecond, rewardTokenDecimals).multipliedBy(rewardTokenPriceInMarketReferenceCurrency);
